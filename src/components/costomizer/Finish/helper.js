...
export async function cartHandler(setStatus, orderConfig, total, productId, signal, updateToast) {
  ...
  try {
    ...
    updateToast("Extracting variant information…");
    ...
    updateToast("Adding item to your cart…");
    await addToCartWithMetadata({
      variantId,
      quantity: orderConfig?.quantity ?? 1,
      properties,
    ...
    updateToast("Done! Redirecting to cart…", "success", false);
