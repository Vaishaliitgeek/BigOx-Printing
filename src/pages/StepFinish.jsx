    ...
    <div className="containerr">
      <div className="preview-section">
        ...
        <div className="preview-box">
          <img
            src="https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=500&h=500&fit=crop"
            alt="Botanical print with orange flowers"
      ...
      <div className="config-section">
        ...
        <div className="border-section">
          ...
          <div className="border-grid">
            <button
              className={`border-button ${borderSize === 'none' ? 'active' : ''}`}
              onClick={() => setBorderSize('none')}
            >
              No Border
            </button>
            <button
